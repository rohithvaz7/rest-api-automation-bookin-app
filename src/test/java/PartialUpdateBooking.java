...
public class PartialUpdateBooking extends BaseTest {
	...
	public void updateBooking(){
		...
		createBooking.createNewBooking("Sandy", "Joe", "114", "false", "2018-01-03", "2018-01-05", "Dinner");
		...
		String setValue = "{\"firstname\":\"Neymar\"}";
		...
		//Checking if partial update has reflected properly after patch
		...
		AllureLogger.logToAllure("Get Response after Patch");
		logResponseAsString(responseAfterPatch);

		BookingDetails bookingDetails = response.as(BookingDetails.class);
		Assert.assertEquals(bookingDetails.getFirstname(), "Neymar");
